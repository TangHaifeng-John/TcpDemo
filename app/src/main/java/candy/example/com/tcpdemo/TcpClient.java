...
public abstract class TcpClient implements Runnable {
    protected static final Logger LOG = Logger.getLogger(TcpClient.class.getSimpleName());
    ...
    public void run() {
        ...
        try {
            ...
            LOG.log(Level.ALL, "unrecoverable error", e);
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        client.setAddress(new InetSocketAddress("127.0.0.1", 4900));
        try {
            client.start();
        } catch (IOException e) {
            e.printStackTrace();
